...
/**
 * Nullable sync-transaction reference shared by response schemas. Deliberately unnamed so
 * each use site emits an inline `anyOf: [$ref, {type: 'null'}]` with no component schema.
 */
