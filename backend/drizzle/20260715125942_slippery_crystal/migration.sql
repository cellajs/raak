...
ALTER TABLE "attachments" ADD COLUMN "public_at" timestamp;--> statement-breakpoint
ALTER TABLE "labels" ADD COLUMN "public_at" timestamp;--> statement-breakpoint
ALTER TABLE "organizations" ADD COLUMN "public_at" timestamp;--> statement-breakpoint
ALTER TABLE "workspaces" ADD COLUMN "public_at" timestamp;--> statement-breakpoint
