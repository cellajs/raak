...
CREATE TABLE "labels" (
	...
	"id" uuid PRIMARY KEY,
	"entity_type" varchar DEFAULT 'label' NOT NULL,
	"tenant_id" varchar(24) NOT NULL,
	"name" varchar(255) DEFAULT 'New label' NOT NULL,
...
CREATE TABLE "projects" (
	"created_at" timestamp DEFAULT now() NOT NULL,
	"id" uuid PRIMARY KEY,
	"entity_type" varchar DEFAULT 'project' NOT NULL,
	"tenant_id" varchar(24) NOT NULL,
...
CREATE TABLE "tasks" (
	"created_at" timestamp DEFAULT now() NOT NULL,
	"id" uuid PRIMARY KEY,
	"entity_type" varchar DEFAULT 'task' NOT NULL,
	"tenant_id" varchar(24) NOT NULL,
	"name" varchar(255) DEFAULT 'New task' NOT NULL,
	"updated_at" timestamp,
	"stx" jsonb NOT NULL,
	"description" varchar(1000000) DEFAULT '',
	"keywords" varchar(1000000) DEFAULT '' NOT NULL,
	...
	"checkbox_count" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "workspaces" (
	"created_at" timestamp DEFAULT now() NOT NULL,
	"id" uuid PRIMARY KEY,
	"entity_type" varchar DEFAULT 'workspace' NOT NULL,
	"tenant_id" varchar(24) NOT NULL,
	"name" varchar(255) NOT NULL,
	"updated_at" timestamp,
	"slug" varchar(255) NOT NULL UNIQUE,
...
CREATE TABLE "tenants" (
	...
	"restrictions" json DEFAULT '{"quotas":{"user":1000,"organization":5,"workspace":0,"project":0,"task":0,"label":0,"attachment":100,"page":0,"chat":0,"message":0},"rateLimits":{"apiPointsPerHour":1000}}' NOT NULL,
	"created_by" uuid,
...
CREATE INDEX "labels_organization_id_index" ON "labels" ("organization_id");--> statement-breakpoint
CREATE INDEX "labels_project_seq_index" ON "labels" ("project_id","seq");--> statement-breakpoint
CREATE INDEX "labels_tenant_id_index" ON "labels" ("tenant_id");--> statement-breakpoint
CREATE INDEX "labels_created_by_index" ON "labels" ("created_by");--> statement-breakpoint
CREATE INDEX "labels_updated_by_index" ON "labels" ("updated_by");--> statement-breakpoint
CREATE INDEX "projects_name_index" ON "projects" ("name" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "projects_created_at_index" ON "projects" ("created_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "projects_tenant_id_index" ON "projects" ("tenant_id");--> statement-breakpoint
CREATE INDEX "projects_organization_id_index" ON "projects" ("organization_id");--> statement-breakpoint
CREATE INDEX "projects_created_by_index" ON "projects" ("created_by");--> statement-breakpoint
CREATE INDEX "projects_updated_by_index" ON "projects" ("updated_by");--> statement-breakpoint
CREATE INDEX "tasks_organization_id_index" ON "tasks" ("organization_id");--> statement-breakpoint
CREATE INDEX "tasks_project_seq_index" ON "tasks" ("project_id","seq");--> statement-breakpoint
CREATE INDEX "tasks_tenant_id_index" ON "tasks" ("tenant_id");--> statement-breakpoint
CREATE INDEX "tasks_created_by_index" ON "tasks" ("created_by");--> statement-breakpoint
CREATE INDEX "tasks_updated_by_index" ON "tasks" ("updated_by");--> statement-breakpoint
CREATE INDEX "tasks_project_status_index" ON "tasks" ("project_id","status");--> statement-breakpoint
CREATE INDEX "idx_tasks_labels_gin" ON "tasks" USING gin ("labels");--> statement-breakpoint
CREATE INDEX "idx_tasks_assigned_to_gin" ON "tasks" USING gin ("assigned_to");--> statement-breakpoint
CREATE INDEX "workspace_name_index" ON "workspaces" ("name" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "workspace_created_at_index" ON "workspaces" ("created_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "workspaces_tenant_id_index" ON "workspaces" ("tenant_id");--> statement-breakpoint
CREATE INDEX "workspaces_organization_id_index" ON "workspaces" ("organization_id");--> statement-breakpoint
CREATE INDEX "workspaces_created_by_index" ON "workspaces" ("created_by");--> statement-breakpoint
CREATE INDEX "workspaces_updated_by_index" ON "workspaces" ("updated_by");--> statement-breakpoint
CREATE INDEX "attachments_organization_id_index" ON "attachments" ("organization_id");--> statement-breakpoint
CREATE INDEX "attachments_project_seq_index" ON "attachments" ("project_id","seq");--> statement-breakpoint
...
CREATE INDEX "chats_project_seq_index" ON "chats" ("project_id","seq");--> statement-breakpoint
...
CREATE INDEX "memberships_project_user_archived_idx" ON "memberships" ("project_id","user_id","archived");--> statement-breakpoint
...
CREATE INDEX "messages_project_seq_index" ON "messages" ("project_id","seq");--> statement-breakpoint
...
ALTER TABLE "labels" ADD CONSTRAINT "labels_tenant_id_tenants_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id");--> statement-breakpoint
ALTER TABLE "labels" ADD CONSTRAINT "labels_created_by_users_id_fkey" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE SET NULL;--> statement-breakpoint
ALTER TABLE "labels" ADD CONSTRAINT "labels_updated_by_users_id_fkey" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE SET NULL;--> statement-breakpoint
...
ALTER TABLE "labels" ADD CONSTRAINT "labels_5EdeIYCO2iQy_fkey" FOREIGN KEY ("tenant_id","organization_id") REFERENCES "organizations"("tenant_id","id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_tenant_id_tenants_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id");--> statement-breakpoint
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_UVK9MNjFoIk5_fkey" FOREIGN KEY ("tenant_id","organization_id") REFERENCES "organizations"("tenant_id","id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_tenant_id_tenants_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id");--> statement-breakpoint
...
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_tenant_id_organization_id_organizations_tenant_id_id_fkey" FOREIGN KEY ("tenant_id","organization_id") REFERENCES "organizations"("tenant_id","id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "workspaces" ADD CONSTRAINT "workspaces_tenant_id_tenants_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id");--> statement-breakpoint
...
ALTER TABLE "workspaces" ADD CONSTRAINT "workspaces_updated_by_users_id_fkey" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE SET NULL;--> statement-breakpoint
ALTER TABLE "workspaces" ADD CONSTRAINT "workspaces_mcfltaO23EEl_fkey" FOREIGN KEY ("tenant_id","organization_id") REFERENCES "organizations"("tenant_id","id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "attachments" ADD CONSTRAINT "attachments_project_id_projects_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "chats" ADD CONSTRAINT "chats_workspace_id_workspaces_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE SET NULL;--> statement-breakpoint
ALTER TABLE "chats" ADD CONSTRAINT "chats_project_id_projects_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE SET NULL;--> statement-breakpoint
...
ALTER TABLE "inactive_memberships" ADD CONSTRAINT "inactive_memberships_workspace_id_workspaces_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "inactive_memberships" ADD CONSTRAINT "inactive_memberships_project_id_projects_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "memberships" ADD CONSTRAINT "memberships_project_id_projects_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_workspace_id_workspaces_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE SET NULL;--> statement-breakpoint
ALTER TABLE "messages" ADD CONSTRAINT "messages_project_id_projects_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE SET NULL;--> statement-breakpoint
...
CREATE POLICY "labels_select_policy" ON "labels" AS PERMISSIVE FOR SELECT TO public USING (
  
  COALESCE(current_setting('app.tenant_id', true), '') != ''
  AND "labels"."tenant_id" = current_setting('app.tenant_id', true)::text

);--> statement-breakpoint
CREATE POLICY "labels_insert_policy" ON "labels" AS PERMISSIVE FOR INSERT TO public WITH CHECK (true);--> statement-breakpoint
CREATE POLICY "labels_update_policy" ON "labels" AS PERMISSIVE FOR UPDATE TO public USING (true);--> statement-breakpoint
CREATE POLICY "labels_delete_policy" ON "labels" AS PERMISSIVE FOR DELETE TO public USING (true);--> statement-breakpoint
CREATE POLICY "tasks_select_policy" ON "tasks" AS PERMISSIVE FOR SELECT TO public USING (
...
CREATE POLICY "tasks_update_policy" ON "tasks" AS PERMISSIVE FOR UPDATE TO public USING (true);--> statement-breakpoint
