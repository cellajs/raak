...
BEGIN
  ...
  BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_publication WHERE pubname = 'cdc_pub') THEN
      CREATE PUBLICATION cdc_pub FOR TABLE users, organizations, attachments, projects, workspaces, tasks, labels, requests, memberships, inactive_memberships, tenants, system_roles;
    ...
    ELSE
      ...
      ALTER PUBLICATION cdc_pub SET TABLE users, organizations, attachments, projects, workspaces, tasks, labels, requests, memberships, inactive_memberships, tenants, system_roles;
...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM pg_catalog.pg_roles WHERE rolname = 'runtime_role') THEN
    ...
    IF NOT EXISTS (
      SELECT 1 FROM pg_class WHERE relname = 'tasks' AND relnamespace = 'public'::regnamespace
        AND relrowsecurity AND relforcerowsecurity
    ) THEN missing := array_append(missing, 'force-rls:tasks'); END IF;
    IF NOT EXISTS (
      SELECT 1 FROM pg_class WHERE relname = 'labels' AND relnamespace = 'public'::regnamespace
        AND relrowsecurity AND relforcerowsecurity
    ) THEN missing := array_append(missing, 'force-rls:labels'); END IF;
    IF NOT EXISTS (
    ...
    IF NOT has_table_privilege('runtime_role', 'public.tasks', 'SELECT') THEN
      missing := array_append(missing, 'grant:tasks'); END IF;
    IF NOT has_table_privilege('runtime_role', 'public.labels', 'SELECT') THEN
      missing := array_append(missing, 'grant:labels'); END IF;
    ...
    IF NOT has_table_privilege('runtime_role', 'public.workspaces', 'SELECT') THEN
      missing := array_append(missing, 'grant:workspaces'); END IF;
    IF NOT has_table_privilege('runtime_role', 'public.projects', 'SELECT') THEN
      missing := array_append(missing, 'grant:projects'); END IF;
    ...
    IF NOT has_table_privilege('runtime_role', 'public.notifications', 'SELECT') THEN
      missing := array_append(missing, 'grant:notifications'); END IF;
    IF NOT has_table_privilege('runtime_role', 'public.notification_preferences', 'SELECT') THEN
      missing := array_append(missing, 'grant:notification_preferences'); END IF;
    IF NOT has_table_privilege('runtime_role', 'public.push_subscriptions', 'SELECT') THEN
      missing := array_append(missing, 'grant:push_subscriptions'); END IF;
