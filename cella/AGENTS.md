...
- **Template/app vocabulary**: use `template` for Cella and `app`, `app-owned`, or `app-specific`
  ...
  `cella.config.ts`; compatibility migrations may name legacy identifiers they must replace.
